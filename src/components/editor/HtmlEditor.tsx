...
const HtmlSourcePanel = ({ htmlSource, onSourceChange, onKeyDown, setSourceLeft, setShowPanel }: {
  htmlSource: string;
...
const HtmlEditor = ({ initialContent, onContentChange }: HtmlEditorProps) => {
  ...
  const panelProps = { htmlSource, onSourceChange: handleSourceChange, onKeyDown: handleSourceKeyDown, setSourceLeft, setShowPanel };
