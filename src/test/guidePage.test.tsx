...
describe("Guide page", () => {
  it("renders the table of contents and core sections", () => {
    ...
    expect(screen.getByText("Open a workflow surface through the navigator")).toBeInTheDocument();
    ...
    expect(screen.getAllByText("Visual Navigator").length).toBeGreaterThan(1);
    ...
    expect(screen.getAllByText("guide.currentBuildNavigatorTitle").length).toBeGreaterThan(0);
    ...
    expect(screen.getAllByAltText("guide.currentBuildNavigatorTitle").length).toBeGreaterThan(0);
    ...
    expect(screen.getByText("What does UI Navigator mean in Docsy?")).toBeInTheDocument();
